...
namespace vshalygin::rpc {
    ...
    iresponse_controller_ex *to_response_controller_ex(google::protobuf::RpcController *source)
    {
        assert(dynamic_cast<response_controller_base *>(source) != nullptr);
        return static_cast<iresponse_controller_ex *>(static_cast<response_controller_base *>(source));
    }
}
