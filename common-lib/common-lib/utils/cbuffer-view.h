...
namespace vshalygin::cl {
    ...
    cbuffer_view::iterator operator+(
                               cbuffer_view::iterator::difference_type offset,
                               const cbuffer_view::iterator &rhs) noexcept;
    cbuffer_view::reverse_iterator operator+(
                                     cbuffer_view::reverse_iterator::difference_type offset,
