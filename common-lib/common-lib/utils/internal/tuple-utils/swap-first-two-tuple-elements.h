...
namespace vshalygin::cl::internal {
    namespace swap_first_two_tuple_elements_impl {
        template<std::size_t... I, class Arg1, class Arg2, class... Args>
        std::tuple<Arg2, Arg1, Args...> swap_first_two_tuple_elements2
    ...
    auto do_swap_first_two_tuple_elements (Tuple &&t)
    {
        ...
        return swap_first_two_tuple_elements_impl::swap_first_two_tuple_elements(
                                                                    std::forward<Tuple>(t));
    }
}
