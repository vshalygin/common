...
//        .catched([](std::exception_ptr) { FAIL(); });
//
//    f.get_data().apply([](int i) { ASSERT_EQ(i, 3); });
//}
//
...
//    auto f2 = p2.get_future();
//
//    const auto data1 = f1.get_data();
//    const auto data2 = f2.get_data();
//    data1.apply([](int i) { ASSERT_EQ(i, 1); });
//    //data.apply([](int &i) { ASSERT_EQ(i, 1); });
//    //data.apply([](int &&i) { ASSERT_EQ(i, 1); });
//    data1.apply([](const int i) { ASSERT_EQ(i, 1); });
...
//    data2.apply([](volatile const int &i) { ASSERT_EQ(i, 4); });
//    //data.apply([](volatile const int &&i) { ASSERT_EQ(i, 1); });
//}
//
...
//    d4.get_data().apply([](const int &) {});
//    d5.get_data().apply([](const int &) {});
//    d6.get_data().apply([](const int &&) {});
//    //d7.get_data().apply([](volatile int &i) { i++; });
//    d8.get_data().apply([](volatile int &i) { i++; });
//    d9.get_data().apply([](volatile int &&i) { i++; });
//    //d10.get_data().apply([](const volatile int &i) { i++; });
//    d11.get_data().apply([](const volatile int &) {});
//    d12.get_data().apply([](const volatile int &&) {});
//    
//    d1.get_data().apply([](int &i) { EXPECT_EQ(2, i); });
//    d2.get_data().apply([](int &i) { EXPECT_EQ(3, i); });
//    d3.get_data().apply([](int &&i) { EXPECT_EQ(4, i); });
//    d4.get_data().apply([](const int &i) { EXPECT_EQ(4, i); });
//    d5.get_data().apply([](const int &i) { EXPECT_EQ(5, i); });
//    d6.get_data().apply([](const int &&i) { EXPECT_EQ(6, i); });
//    //d7.get_data().apply([](volatile int &i) { EXPECT_EQ(8, i); });
//    d8.get_data().apply([](volatile int &i) { EXPECT_EQ(9, i); });
//    d9.get_data().apply([](volatile int &&i) { EXPECT_EQ(10, i); });
//    //d10.get_data().apply([](const volatile int  &i) { EXPECT_EQ(11, i); });
//    d11.get_data().apply([](const volatile int &i) { EXPECT_EQ(11, i); });
//    d12.get_data().apply([](const volatile int &&i) { EXPECT_EQ(12, i); });
//    EXPECT_EQ(i2, 3);
//    EXPECT_EQ(i3, 4);
//    EXPECT_EQ(i5, 5);
//    EXPECT_EQ(i6, 6);
