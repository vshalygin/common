...
TEST_F(UniquePtr, MayBeCreated)
{
    ...
    EXPECT_TRUE(life_cycle_tracker::ctor_called == 1);
    EXPECT_TRUE(life_cycle_tracker::dtor_called == 1);
    EXPECT_TRUE(life_cycle_tracker::copy_called == 0);
    EXPECT_TRUE(life_cycle_tracker::move_called == 0);
    EXPECT_TRUE(life_cycle_tracker::copy_assign_called == 0);
    EXPECT_TRUE(life_cycle_tracker::move_assign_called == 0);
}
...
{
    {
        ...
        unique_ptr<test_class> ptr2 = make_unique<test_class>();
        ptr2 = std::move(ptr1);
